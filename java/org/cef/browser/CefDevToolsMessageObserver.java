...
interface CefDevToolsMessageObserver {
    ...
    /**
     * Called when the DevTools agent attaches, generally after the first protocol message sent
     * following a detach.
     *
     * @param browser the originating browser instance
     */
    default void onDevToolsAgentAttached(CefBrowser browser) {}

    /**
     * Called when the DevTools agent detaches. Pending results will never be delivered and active
     * protocol subscriptions have been canceled by CEF.
     *
     * @param browser the originating browser instance
     */
    default void onDevToolsAgentDetached(CefBrowser browser) {}
}
