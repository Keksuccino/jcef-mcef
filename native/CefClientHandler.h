 ...
 */
JNIEXPORT void JNICALL Java_org_cef_handler_CefClientHandler_N_1removeAudioHandler
  (JNIEnv *, jobject, jobject);

/*
 * Class:     org_cef_handler_CefClientHandler
 * Method:    N_removeDownloadHandler
 * Signature: (Lorg/cef/handler/CefDownloadHandler;)V
 */
 ...
 */
JNIEXPORT void JNICALL Java_org_cef_handler_CefClientHandler_N_1removePermissionHandler
  (JNIEnv *, jobject, jobject);
 ...
 */
JNIEXPORT void JNICALL Java_org_cef_handler_CefClientHandler_N_1removePrintHandler
  (JNIEnv *, jobject, jobject);
