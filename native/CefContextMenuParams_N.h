...
/*
 * Class:     org_cef_callback_CefContextMenuParams_N
 * Method:    N_GetTitleText
 * Signature: (J)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_org_cef_callback_CefContextMenuParams_1N_N_1GetTitleText
  (JNIEnv *, jobject, jlong);
...
/*
 * Class:     org_cef_callback_CefContextMenuParams_N
 * Method:    N_IsCustomMenu
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_org_cef_callback_CefContextMenuParams_1N_N_1IsCustomMenu
  (JNIEnv *, jobject, jlong);
